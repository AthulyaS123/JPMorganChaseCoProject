...
//
//    //change ur MOM
//    public void getTableSizes() throws IOException
//    {
...
//                query.append(hello);
////                query.append(" WHERE keyspace_name=\'" + x + "\' table_name=\'" + i + "\';");
//                ResultSet resultSet = session.execute(query.toString());
//                Long xd = null;
//                for(Row j: resultSet){
//                    xd = (Long)(j.get("mean_partition_size", GenericType.BIG_INTEGER).multiply(j.get("partitions_count", GenericType.BIG_INTEGER))));
//                }
//                System.out.println(x + " " + i + " " + xd);
...
////            return freShaVaCaDo; //aHHHHHH so sexy
////        return null;
//    }
//
