...
public class ModifierMethods {
    ...
    public void insertRow(String keyspace,String table, Map<String, String>CTV, int TTL){
    ...
    public void editRow(String keyspace,String table, Map<String, String>PKV,Map<String, String>NPKV, int TTL){
